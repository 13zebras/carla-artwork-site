...
export function Portfolio({ artworks, title, description }: PortfolioProps) {
  ...
  return (
    <main
      ...
      className='opacity-100 mx-auto px-8 xxs:px-8 xs:px-10 sm:px-12 md:px-14 pt-46 xs:pt-42 sm:pt-44 xl:pt-40 pb-12 max-w-7xl'
    >
      <div data-portfolio-content>
        ...
        <div className='gap-12 columns-1 sm:columns-2 lg:columns-3'>
