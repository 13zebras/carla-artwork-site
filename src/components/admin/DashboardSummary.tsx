...
export function DashboardSummary({
  ...
  return (
    <section className='flex flex-wrap justify-center gap-4 xl:gap-6'>
      <Card className='dashboard-summary-card'>
        <CardTitle className='text-md text-center'>Database Records</CardTitle>

        <CardContent className='text-2xl tabular-nums px-0 text-center'>
          {dashboard.records.length.toLocaleString('en-US')}
        </CardContent>
      </Card>
      <Card className='dashboard-summary-card'>
        <CardTitle className='text-md text-center'>Bunny Image Files</CardTitle>
        <CardContent className='text-2xl tabular-nums px-0 text-center'>
      ...
      >
        <CardTitle className='text-md text-center'>Image Not in DB</CardTitle>
        <CardContent className='text-2xl tabular-nums px-0 text-center'>
      ...
      >
        <CardTitle className='text-md text-center'>DB Missing Image</CardTitle>
        <CardContent className='text-2xl tabular-nums px-0 text-center'>
          {missingRecords.length.toLocaleString('en-US')}
        </CardContent>
      </Card>
      <Card className='dashboard-summary-card'>
        <CardTitle className='text-md text-center'>Active Categories</CardTitle>
        <CardContent className='text-2xl tabular-nums px-0 text-center'>
